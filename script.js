    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "unfold uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '6a65a341-9921-4c4f-8017-22b94661db89',
                    name: data.name || '',
                    email: data.email || '',
